...
class ProductsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.products.create', compact('categories', 'tags', 'types'));
    }
    ...
    public function store(StoreProductsRequest $request)
    {
        ...
        $product->type()->sync(array_filter((array)$request->input('type')));
    ...
    public function edit($id)
    {
        ...
        return view('admin.products.edit', compact('product', 'categories', 'tags', 'types'));
    }
    ...
    public function show($id)
    {
        ...
        $types = \App\Type::get()->pluck('title', 'id');
$orders = \App\Order::where('product_id', $id)->get();$likes = \App\Like::where('product_id', $id)->get();$comments = \App\Comment::where('product_id', $id)->get();$downloads = \App\Download::where('product_id', $id)->get();

        $product = Product::findOrFail($id);

        return view('admin.products.show', compact('product', 'orders', 'likes', 'comments', 'downloads'));
    }
