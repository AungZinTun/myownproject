...
class LikesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.likes.create', compact('products'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.likes.edit', compact('like', 'products'));
    }
    ...
    public function restore($id)
    {
        ...
        $like = Like::onlyTrashed()->findOrFail($id);
        $like->restore();
    ...
    /**
     * Permanently delete Like from storage.
     *
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
